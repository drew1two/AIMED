...
By contributing to AIMED, you agree that your contributions will be licensed under the same [Apache-2.0 License](LICENSE) as the project.

**Important**: AIMED extends ConPort MCP (Apache-2.0). Contributions to ConPort MCP components should also be submitted upstream to the [original ConPort repository](https://github.com/GreatScottyMac/context-portal).
