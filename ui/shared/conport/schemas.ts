...
// get_all_custom_data_by_id_desc
export const GetAllCustomDataByIdDescArgsSchema = z.object({
  workspace_id: z.string(),
  limit: z.number().int().min(1).optional().nullable()
});
export type GetAllCustomDataByIdDescArgsType = z.infer<typeof GetAllCustomDataByIdDescArgsSchema>;
...
export const ToolArgSchemas = {
  ...
  get_all_custom_data_by_id_desc: GetAllCustomDataByIdDescArgsSchema,
