...
mem4sprint_strategy:
  ...
  # Handle initialization when folder doesn't exist
  ...
  # UI Launch question (only after ConPort is verified to exist)
  ...
  proactive_linking_policy:
    ...
    relationship_types: ["BLOCKED_BY", "IMPLEMENTS", "VERIFIES", "DEPENDS_ON", "PRODUCES", "CONSUMES", "DERIVED_FROM", "RELATED_TO", "CLARIFIES", "RESOLVES", "TRACKS"]
    process:
